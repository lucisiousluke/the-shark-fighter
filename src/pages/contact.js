    ...
    return (
        <main>
            <Layout>
                ...
                />
                <section className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 max-w-7xl mx-auto my-20 h-96">
                    <div className="bg-slate-50 text-white rounded-lg col-span-3 p-6">
                        ...
                        <p className="text-slate-500">UX/UI research, web development, brand management</p>
