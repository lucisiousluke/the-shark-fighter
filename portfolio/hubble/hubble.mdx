...
<div>
<Image src="hubble/hubble-desktop.webp" alt="An air-soft spread" className="w-full rounded-lg" />
</div>
</ProjectSection>
...
<div>
<Image src="hubble/hubble_event_photo.jpg" alt="An air-soft spread" className="w-full rounded-lg" />
</div>
<div>
## Objective
...
<div>
<Image src="hubble/dry-erase-board.jpg" alt="An air-soft spread" className="w-full rounded-lg" />
</div>
</ProjectSection>

<ProjectSection bgColor="bg-slate-50" fiftyFifty>
<div>
<Image src="hubble/hubble-home-page-redesign.jpg" alt="An air-soft spread" className="w-full rounded-lg" />
</div>
<div>
...
<div>
<Image src="hubble/growth-magizne.jpg" alt="An air-soft spread" className="w-full rounded-lg" />
