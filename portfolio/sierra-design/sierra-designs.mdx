...
<Image src="sierra-design/sierradesigns-trailhead-shadow.jpg" alt="An air-soft spread" className="w-full" />
<Image src="sierra-design/sierra-taquito-shadow.jpg" alt="An air-soft spread" className="w-full" />
...
<Image src="sierra-design/sierra-design-seek-spread.jpg" alt="An air-soft spread" className="w-full" />
<Image src="sierra-design/co_op_ad_stpread.jpg" alt="An air-soft spread" className="w-full" />
