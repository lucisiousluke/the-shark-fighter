...
<div>
<Image src="sierra-design/sierra_designs_catalog_resize.jpg" alt="An air-soft spread" className="w-full rounded-xl" />
</div>
</ProjectSection>
...
<div>
<Image src="sierra-design/sierra-design-catalog-open.jpg" alt="An air-soft spread" className="w-full rounded-xl" />
<Image src="sierra-design/sierra_designs_catalog_2-resize.jpg" alt="An air-soft spread" className="w-full" />
</div>
</ProjectSection>

<ProjectSection fiftyFifty>
<div>
<Image src="sierra-design/sierradesigns-trailhead-shadow.jpg" alt="An air-soft spread" className="w-full rounded-xl" />
<Image src="sierra-design/sierra-taquito-shadow.jpg" alt="An air-soft spread" className="w-full rounded-xl" />
</div>
<div>
### **Event Signage**
...
<div>
<Image src="sierra-design/sierra-design-seek-spread.jpg" alt="An air-soft spread" className="w-full rounded-xl" />
<Image src="sierra-design/co_op_ad_stpread.jpg" alt="An air-soft spread" className="w-full rounded-xl" />
</div>
</ProjectSection>
