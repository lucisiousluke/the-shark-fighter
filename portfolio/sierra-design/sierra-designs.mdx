...
Brand Development: Refining Sierra’s visual identity to align with the 2008 Outdoor Sportsman Show and resonate with the target audience.
Asset Creation: Designing and producing a comprehensive catalog, event signage, advertisements, and marketing materials for the show.
Product Photography Management: Coordinating and overseeing product photography to ensure high-quality visuals for marketing materials.
Leadership and Adaptability: Taking ownership of the brand’s direction and marketing efforts during a time of significant organizational change.
