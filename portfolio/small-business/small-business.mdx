...
gallery_images:
  - image: ./prox-advice-gen1.jpg
    alt: "Prox.io advice page"
  - image: ./prox-blog-gen1.jpg
    alt: "Prox.io blog page"
  - image: ./prox-experts-gen1.jpg
    alt: "prox.io experts page"
  - image: ./prox-leadership-gen1.jpg
    alt: "prox.io leadership page"
  - image: ./rusty-flame-home.jpg
    alt: "Rusty Flame Candle Shop home page"
  - image: ./rusty-flame-products.jpg
    alt: "Rusty Flame Candle Shop products page"
  - image: ./rusty-flame-datasheet.jpg
    alt: "Rusty Flame Candle Shop product details page"
  - image: ./rusty-flame-checkout.jpg
    alt: "Rusty Flame Candle Shop checkout page"
  - image: ./wanderflowers-home-v2.jpg
    alt: "Wander Flowers home page"
  - image: ./wanderflowers-home.jpg
    alt: "Wander Flowers about page"
  - image: ./wanderflowers-buying.jpg
    alt: "Wander Flowers buying page"
  - image: ./wanderflowers-selling.jpg
    alt: "Wander Flowers selling page"
  - image: ./wanderflowers-staging.jpg
    alt: "Wander Flowers staging page"
  - image: ./wanderflowers-blog.jpg
    alt: "Wander Flowers blog page"
  - image: ./wanderflowers-blog-detail.jpg
    alt: "Wander Flowers blog detail page"
---
...
<div>
<Image src="small-business/home-wanterflowers-shadow.jpg" alt="Real estate website home page" className="w-full rounded-xl mb-6" />
<Image src="small-business/blog-post-shadow.png" alt="Real estate website pages" className="w-full rounded-xl mb-6" />
...
<ProjectSection fiftyFifty>
<div>
<Image src="small-business/prox-home-laptop.jpg" alt="Prox home page laptop image" className="w-full rounded-xl mb-6" />
<Image src="small-business/prox-brainpower-shadow.jpg" alt="Prox about us page" className="w-full rounded-xl mb-6" />
...
<div>
<Image src="small-business/perspective-image.jpg" alt="Candle shop home page on laptop" className="w-full rounded-xl mb-6" />
<Image src="small-business/rusty-flame-about-shadow.jpg" alt="Rusty Flame Candle Shop about us page" className="w-full rounded-xl mb-6" />
