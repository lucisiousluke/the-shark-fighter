...
hero_image_thumbnail: "./prox-home-laptop.jpg"
...
<div>
<Image src="small-business/home-wanterflowers-shadow.jpg" alt="An air-soft spread" className="w-full rounded-xl" />
<Image src="small-business/blog-post-shadow.png" alt="An air-soft spread" className="w-full rounded-xl" />
<Image src="small-business/Selling-wanderflowerandco-shadow.jpg" alt="An air-soft spread" className="w-full rounded-xl" />
</div>
</ProjectSection>
...
<ProjectSection fiftyFifty>
<div>
<Image src="small-business/prox-home-laptop.jpg" alt="An air-soft spread" className="w-full rounded-xl" />
<Image src="small-business/prox-brainpower-shadow.jpg" alt="An air-soft spread" className="w-full rounded-xl" />
<Image src="small-business/blog-prox-shadow.jpg" alt="An air-soft spread" className="w-full rounded-xl" />
</div>
<div>
...
<div>
<Image src="small-business/perspective-image.jpg" alt="An air-soft spread" className="w-full rounded-xl" />
<Image src="small-business/rusty-flame-about-shadow.jpg" alt="An air-soft spread" className="w-full rounded-xl" />
<Image src="small-business/Cart–The-Rusty-Flame-Candle-Co-shadow.jpg" alt="An air-soft spread" className="w-full rounded-xl" />
</div>
</ProjectSection>
