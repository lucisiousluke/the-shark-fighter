...
gallery_images:
  - image: ./comp-obt-datasheet-crop-image-1.jpg
    alt: "version 1 datasheet comp"
  - image: ./comp-obt-datasheet-crop-image-2.jpg
    alt: "version 2 datasheet comp, more products shown"
  - image: ./comp-obt-datasheet-crop-image-3.jpg
    alt: "version 3 datasheet comp, accordions replacing tabs"
  - image: ./comp-obt-datasheet-crop-image-4.jpg
    alt: "datasheet concept, multiple product sizes displayed"
  - image: ./comp-obt-search-crop-image-1.jpg
    alt: "full site search gen 1"
  - image: ./comp-obt-contact-crop-image-1.jpg
    alt: "contact us page concept"
  - image: ./comp-obt-cart-image-1.jpg
    alt: "cart checkout step 2"
  - image: ./comp-obt-cart-image-2.jpg
    alt: "cart checkout completed"
  - image: ./comp-obt-content-v1.jpg
    alt: "internal page comp"
  - image: ./comp-obt-home-image-2.jpg
    alt: "update home page concept"
  - image: ./comp-rnd2-typography-1.png
    alt: "typography and font scale"
  - image: ./comp-rnd2-spacing-1.jpg
    alt: "sizing system"
  - image: ./comp-rnd2-cta-1.jpg
    alt: "CTA variations"
  - image: ./comp-rnd2-nav-1.jpg
    alt: "navigation component"
  - image: ./site-obt-home-1.jpg
    alt: "home page concept version 2(final)"
  - image: ./site-obt-antibodies-1.jpg
    alt: "antibodies internal page"
---
...
<ProjectSection fiftyFifty>
<div>
<Image src="one-web-bio-techne/figma-comps-components.jpg" alt="bio-techne component library" className="rounded-lg shadow-lg w-full" />
</div>
<div>
...
<ProjectSection bgColor="bg-slate-50" fiftyFifty>
<div>
<Image src="one-web-bio-techne/hot-jar-testing.jpg" alt="bio-techne HotJar testing" className="rounded-lg shadow-lg w-full mb-6" />
