...
hero_image: "./bio-techne_computer_tablet_mobile_product_pages.jpg"
...
<Image src="one-web-bio-techne/1bt-evolution.jpg" alt="An air-soft spread" className="rounded-lg shadow-lg w-full" />
...
<Image src="one-web-bio-techne/market-research.jpg" alt="An air-soft spread" className="rounded-lg shadow-lg w-full" />
