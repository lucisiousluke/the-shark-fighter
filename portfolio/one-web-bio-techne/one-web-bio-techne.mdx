...
<Image src="one-web-bio-techne/bio-techne-pages.png" alt="An air-soft spread" className="w-full" />
</ProjectSection>
...
<div>
<Image src="one-web-bio-techne/brand-consolidation.jpg" alt="An air-soft spread" className="rounded-lg shadow-lg w-full" />
</div>
</ProjectSection>
...
<ProjectSection twoColumn leftSide={false}>
<div>
<Image src="one-web-bio-techne/compitition.jpg" alt="An air-soft spread" className="rounded-lg shadow-lg w-full" />
</div>
<div>
...
<ProjectSection bgColor="bg-slate-50" twoColumn leftSide={true}>
<div>
...
<div>
<Image src="one-web-bio-techne/one-web-workflow.png" alt="An air-soft spread" className="rounded-lg shadow-lg w-full" />
</div>
</ProjectSection>

<ProjectSection twoColumn>
<div>
<Image src="one-web-bio-techne/work-flow-product-pages.jpg" alt="An air-soft spread" className="rounded-lg shadow-lg w-full" />
</div>
<div>
...
<div>
<Image src="one-web-bio-techne/figma-comps-full-site.jpg" alt="An air-soft spread" className="rounded-lg shadow-lg w-full" />
</div>
</ProjectSection>
...
<div>
<Image src="one-web-bio-techne/Analytics-360.png" alt="An air-soft spread" className="rounded-lg shadow-lg w-full" />
</div>
</ProjectSection>
